declare module "uxp/components" {
    ...
    export interface ISelectProps {
         ...
         */
        getPaginatedOptions?: (max: number, lastToken: string, query?: string) => Promise<{ items: any[], pageToken: string }>
    ...
    *      <AutoCompleteInput
    ...
    export const TreeViewSelectInput:React.ForwardRefExoticComponent<TreeViewSelectInputProps & React.RefAttributes<TreeViewSelectInputInstanceProps>>;
        export const useEventSubscriber:IEventSubscriber;    export const useToast:ToastHook;    export const useAlert:AlertHook;    export const useDebounce:DebounceHook;    export const useResizeEffect:ResizeEffectHook;    export const useMessageBus:MessageBusHook;    export const useFields:FieldsHook;    export const useUpdateWidgetProps:IUseUpdateWidgetProps;    export const useEffectWithPolling:IUseEffectWithPolling;
}
